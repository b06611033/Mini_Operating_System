...
/* EXTERNS */
/*--------------------------------------------------------------------------*/
extern Scheduler * SYSTEM_SCHEDULER; // SYSTEM_SCHEDULER is defined at kernel.C
...
static void thread_shutdown() {
    ...
    SYSTEM_SCHEDULER->terminate(Thread::CurrentThread());  // calls scheduler function to terminate current thread
}
...
// threads that reaches Round Robin quantum time will trigger this function
void Thread::preempt() {
